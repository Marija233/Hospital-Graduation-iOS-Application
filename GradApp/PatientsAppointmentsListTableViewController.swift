//
//  PatientsAppointmentsListTableViewController.swift
//  GradApp
//
...
class PatientsAppointmentsListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "appointments2Cell", for: indexPath)

     let appointmentDictionary = appointmentRequests[indexPath.section]
      if let doctorFullName = appointmentDictionary["doctorFullName"] as? String {
         ...
         //  let profileImageUrl = appointmentDictionary["profileImageUrl"] as? String
                   ...
                   //completionHandler: { (data, response, error) in
                               ...
                               cell.textLabel?.text = "Dr. " + doctorFullName
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
               ...
               performSegue(withIdentifier: "nextSegue", sender: appointmentRequest)
           }
    ...
    */
    ...
    if let acceptVC4 = segue.destination as? PatientsAppointmentsDataViewController{
            ...
            if let date = appointmentRequest["date"] as? String {
                  ...
                  if let diagnosis = appointmentRequest["diagnosis"] as? String {
                    ...
                    if let doctorFullName = appointmentRequest["doctorFullName"] as? String {
                        ...
                        acceptVC4.DoctorId = DoctorId
                              acceptVC4.PatientId = PatientId
                    acceptVC4.date  = date
                              acceptVC4.diagnosis = diagnosis
                        acceptVC4.doctorFullName = doctorFullName
                            
                            acceptVC4.examination = examination
                                
                                acceptVC4.id = id
                                    acceptVC4.patientFullName = patientFullName
                                        acceptVC4.profileImageUrl = profileImageUrl
                                                 acceptVC4.status = status
                                                 acceptVC4.symptoms = symptoms
                                                 acceptVC4.therapy = therapy
